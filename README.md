...
### Проверка публичного доступа к файлу
...
### Проверка веб-страницы на Instance
...
### Проверка отказоустойчивости через CLI
...
### Проверка VM после настройки балансировщика
...
### Проверка состояния Load Balancer в консоли

**Просмотр в YC — *Network Load Balancer → lamp-network-lb → Обзор***.  
...
### Общий обзор инфраструктуры в YC
